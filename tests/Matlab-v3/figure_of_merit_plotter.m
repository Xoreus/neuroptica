...
diamond = [0.17438, 0.04641, 0.02072, 0.01984, 0.00984]; % Loss-PU
reck =    [0.10625, 0.03938, 0.01556, 0.01109, 0.00391]; % Loss-PU
N =       [4,       8,       12,      16,      32];
...
xticks([4, 8, 12, 16, 32])
xlabel('$N$', 'fontsize', fontsz*0.8, 'interpreter','latex')
ylabel('FoM $(Rad \cdot dB)$', 'fontsize', fontsz*0.8, 'interpreter','latex')
% axis square
grid('on')
pMe('/storage/Research/02.2020-NewPaper/Scalability.pdf')
